...
def main():
    API_KEY = os.environ.get("DEEPSEEK_API_KEY", "sk-e486bfb0e32a47dd94de58c36fd168c2")

    # ===== 在此配置输入输出路径 =====
    input_file = "D:/work/MinerU/JSON格式/MinerU_英文7 Polyurethane-modifed room-temperature curing epoxy super adhesive for__20260528025847.json"
    output_file = "D:/work/MinerU/JSON格式/数据集（初版）/英文7.json"
    # ================================
